import { CreatePermissionDTO, CreateRoleDTO, RoleEntity } from '@authdare/models';
 ...
 * @returns 
 */
export async function createRoleAndPermissions(orgname?: string): Promise<RoleEntity> {
    ...
    return await rs.create(new CreateRoleDTO({
        name: 'ADMIN',
